...
function Footer() {
  ...
  width: "100%"}}>
    <ul class="nav justify-content-center border-bottom pb-3 mb-3">
      <li class="nav-item"><NavLink className="nav-links text-white" style={{color:"white"}} exact to="/">Home</NavLink></li>
      ...
      <li class="nav-item"><NavLink className="nav-links text-white" style={{color:"white"}} exact to="/about">About Us</NavLink></li>
      <li class="nav-item"><NavLink className="nav-links text-white" style={{color:"white"}} exact to="/contact">Contact Us</NavLink></li>
    </ul>
